...
const initialPayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.default.post(process.env.PAYMENT_URL, {
        ...
        success_url: `https://recipe-sharing-be.vercel.app/api/payment/confirmation?transactionId=${paymentData.transactionId}&status=success`,
        fail_url: `https://recipe-sharing-be.vercel.app/api/payment/confirmation?status=failed`,
